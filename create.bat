...
Powershell Compress-Archive -Path .\build\!version!\firefox\* -DestinationPath .\build\!version!\niconico-peppermint.zip
...
Powershell Compress-Archive -Path .\build\!version!\chrome\ -DestinationPath .\build\!version!\niconico-peppermint-chrome.zip
echo completed!
pause