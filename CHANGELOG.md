...
- DMS: 公開マイリストページのダークモードサポートを追加しました

## [3.1.9] - 2025/09/16

### Fixed
- TWEAK: ランキングページのニコニ広告行を隠すとカスタムランキングレーンの設定が表示されなくなる問題を修正しました
- TWEAK: 「ジャンルと投稿日時以外のメタデータを隠す」が新検索ページに対応しました
- DMS: 旧検索ページのダークモードサポートが適用されない問題を修正しました
...
### Fixed
- DMS: お知らせポップアップのダークモードサポートを更新しました
...
[3.1.1]: https://github.com/castella-cake/niconico-peppermint-extension/releases/tag/v3.1.0...v3.1.1
