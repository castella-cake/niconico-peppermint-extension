...
### Added
- PMW: MintWatch を追加しました   
PepperMint+ オリジナルの新しくミニマルな視聴ページです。
...
### Removed
- STOCK: 非推奨としてマークされていたシリーズストックのニコニコ内表示は削除されました
...
[UnReleased]: https://github.com/castella-cake/niconico-peppermint-extension/compare/v2.1.3...HEAD
