...
import { addItemToMylist, getMylists } from "../../../modules/watchApi";
...
export function Mylist({ onClose, videoInfo }: Props) {
    ...
    return <div className="mylists-container" id="pmw-mylists">
        <div className="mylist-title global-flex"><span className="global-flex1">マイリストへ追加</span><button onClick={onClose}><IconX/></button></div>
